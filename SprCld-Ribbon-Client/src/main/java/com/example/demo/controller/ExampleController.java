...
public class ExampleController {
    ...
    public String showFirstService() {
        ...
        String serviceId = "restService".toLowerCase();
        ...
        html += "<br><h4>Call /Ping of service: " + serviceId + "</h4>";
        ...
        try {
            ...
            String url = "http://" + serviceInstance.getHost() + ":" + serviceInstance.getPort() + "/server-location";
